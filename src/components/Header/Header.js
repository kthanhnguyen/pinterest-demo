    ...
    return (
      <header className="header">
        <div className="header__logo">
          <Link to="/">
            <svg className="gUZ" height={28} width={28} viewBox="0 0 24 24">
          ...
          <div className="header__search-inner">
            ...
            <div className="header__search-input">
              <input
                type="text"
                autoComplete="off"
                className="SearchBoxInputExperimental"
                name="searchBoxInput"
                placeholder="Search"
              />
            </div>
        ...
        <div className="header__right">
          <div className="header__link">
            <ul>
              ...
              <li>
                <NavLink to="/">Kim</NavLink>
              </li>
            </ul>
          </div>
          <div className="header__info">
            <div className="header__mess header__info-item">
              <button>
                <svg className="gUZ" height={24} width={24} viewBox="0 0 24 24">
            ...
            <div className="header__noti header__info-item">
              <button>
                <svg className="gUZ" height={24} width={24} viewBox="0 0 24 24">
            ...
            <div className="header__menu header__info-item">
              <button>
                <svg className="gUZ" height={24} width={24} viewBox="0 0 24 24">
